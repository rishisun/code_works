...
public class WordLength {
	...
	public static void main(String[] args) {
		...
		String words[] = { "zero ", "one ", "two ", "there ", "four ", "five ", "six ", "seven ", "eigth ", "nine ",
				"ten ", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixtenn", "seventeen", "eigteen",
				"nineteen", "twenty ", "thirty ", "fourty ", "fifty ", "sixty ", "seventy ", "eighty ", "ninty ",
				"hundred ", "thousand ", "and " };
		int count[] = { 4, 3, 3, 5, 4, 4, 3, 5, 5, 4, 3, 6, 6, 8, 8, 7, 7, 9, 8, 8, 6, 6, 6, 5, 5, 7, 6, 6, 7, 8, 3 };
		...
		if (n < 21) {
			...
			if (ones != 0) {
				...
				System.out.print(n + " : ");
				if (ones != 0) {
					System.out.println(words[thousand]+words[30]+words[hundreds] + words[28] + words[30] + words[tens] + words[ones]);
					System.out.println(count[thousand]+count[30]+count[hundreds] + count[28] + count[30] + count[tens] + count[ones]);
				} else {
